...
curl "https://qqcyn6e2xc.execute-api.ap-northeast-2.amazonaws.com/v1beta1/projects/{projectId}/indexes" \
...
curl -i -X POST "https://qqcyn6e2xc.execute-api.ap-northeast-2.amazonaws.com/v1beta1/projects/{projectId}/indexes" \
  -H "content-type: application/json" \
  -H "x-api-key: $AIMP_PROJECT_API_KEY" \
  -d '{
...
```
As shown above example, you cannot specify the `mappings` parameter when cloning an index.